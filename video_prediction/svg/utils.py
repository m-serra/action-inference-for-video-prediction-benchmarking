...
def load_dataset(dataset, data_root, n_past, n_future, n_eval,  image_width):

    # if dataset == 'bair':
    from video_prediction.svg.data.bair import RobotPush
...
def normalize_data(dataset, dtype, sequence):
    if dataset == 'smmnist' or dataset == 'kth' or dataset == 'bair' :
